...
const   nftSection = () => {
    ...
    <div>
       ...
       <div>
           ...
           <div>
           <h1 className="text-lg font-bold  pl-2">World of women galaxies</h1>
           <p className="pl-2 text-gray-400">$27,868,412</p>
           </div>
           </div>
           <div className="flex">
           <img className="rounded-full w-12 h-12" src="https://img.rarible.com/prod/image/upload/t_avatar_big/prod-collections/0xed5af388653567af2f388e6224dc7c4b3241c544/avatar/QmbJit1a9Jp35D2AZdiTdfLn6JCXQSbn1Lw237qZWfCMfe"></img>
           <div>
           ...
           <div className="flex">
           <img className="rounded-full w-12 h-12" src="https://img.rarible.com/prod/image/upload/t_avatar_big/prod-collections/0x4b61413d4392c806e6d0ff5ee91e6073c21d6430/avatar/QmdMCh8pz7Bc822VrGXUgszAj2snusSZAvjUupf8qKsZTR"></img>
           <div>
           ...
           <div className="flex">
           <img className="rounded-full w-12 h-12" src="https://img.rarible.com/prod/image/upload/t_avatar_big/prod-collections/0x49cf6f5d44e70224e2e23fdcdd2c053f30ada28b/avatar/QmTNRdwYvd5nsMVoUGX4Gu2ZWwgbKbu9NNdxDLtcwEE8Kr"></img>
           <div>
           ...
           <div className="flex">
           <img className="rounded-full w-12 h-12" src="https://img.rarible.com/prod/image/upload/t_avatar_big/prod-collections/0xd4e4078ca3495de5b1d4db434bebc5a986197782/avatar/QmWAnvv3NKhYeHs6MDhvQzjcy68j7wmzHin7ofKgQkQ5cK"></img>
           <div>
           ...
           <div className="flex">
           <img className="rounded-full w-12 h-12" src="https://img.rarible.com/prod/image/upload/t_avatar_big/prod-collections/0xe785e82358879f061bc3dcac6f0444462d4b5330/avatar/QmQ6LSQGjGCbiRaeivRiAJHwxcKsZ2fRnFtLMNQKLJZWc8"></img>
           <div>
       ...
       <div className="flex mt-8">
           ...
           <img className="mx-6 w-8 h-8" src="https://rarible.com/9b703a21b9f93a1f0065.svg"></img>
       ...
       <div className="border-2 rounded-2xl mx-auto mb-3">
       <img className="rounded-full w-10 h-10 ml-3 mt-2 mb-2" src="https://img.rarible.com/prod/image/upload/t_avatar_big/prod-collections/0x49cf6f5d44e70224e2e23fdcdd2c053f30ada28b/avatar/QmTNRdwYvd5nsMVoUGX4Gu2ZWwgbKbu9NNdxDLtcwEE8Kr"></img>
       <img className="w-44 h-60 my-2 ml-7 rounded-lg" src="https://img.rarible.com/prod/image/upload/t_image_preview/prod-itemImages/0x79fcdef22feed20eddacbb2587640e45491b757f:7554/3de4e9b"></img>
       <div className="flex mt-8">
       ...
       <div className="border-2 rounded-2xl mx-auto mb-3">
       <img className="rounded-full w-10 h-10 ml-3 mt-2 mb-2" src="https://img.rarible.com/prod/image/upload/t_avatar_big/prod-collections/0x49cf6f5d44e70224e2e23fdcdd2c053f30ada28b/avatar/QmTNRdwYvd5nsMVoUGX4Gu2ZWwgbKbu9NNdxDLtcwEE8Kr"></img>
       <img className="w-44 h-60 my-2 ml-6 rounded-lg" src="https://img.rarible.com/prod/image/upload/t_image_preview/prod-itemImages/0xccc441ac31f02cd96c153db6fd5fe0a2f4e6a68d:9106/de0c2d4"></img>
       <div className="flex mt-8">
