    ...
    return (
        <div className="sm:flex sm:items-start">
            ...
            <div className="mt-3 text-center sm:mt-2 sm:ml-4">
                <h3 className={`text-lg font-medium ${uploadStatus.imageUploaded && !uploadStatus.transactionApproved ? "text-gray-900 animate-pulse" : uploadStatus.nftListed ? "text-gray-900" : "text-gray-500"}`} id="modal-title">{uploadStatus.nftListed ? "NFT Listed!" : "Listing NFT"}</h3>
            </div>
        </div>
    )
}
